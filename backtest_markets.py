...
def main():
    ...
    rl_base=float(np.mean(rl15y)); over_base=float(np.mean(tot85y)); ml_base=float(np.mean(y))
    out={
      ...
      'over_signals_ge_59':selective(tot85y,tot85,.59),'over_signals_ge_60':selective(tot85y,tot85,.60),
